...
<template>
    ...
    <section>
        <div id="buttons" class="store">
            <button class="btn" @click="filterObjects()">All</button>
            <button class="btn" @click="filterObjects('mules')">Mules</button>
            <button class="btn" @click="filterObjects('shoes')">Shoes</button>
            <button class="btn" @click="filterObjects('belts')">Belts</button>
            <button class="btn" @click="filterObjects('wallets')">Wallets</button>
            <button class="btn" @click="filterObjects('sliders')">Slides</button>
        </div>
        ...
        <section class="store_section">
            <div class="items slide_pane" id="slides">
                ...
                <figure v-for="(product, id) in products" :key="id" id="productOne" class="good mules">
                    <img src="@/assets/homeBg1.jpg" alt="" class="img_class">
            ...
            <!--Pop up upon onclick of any product card -->
            ...
            <!--    <div class="product_card">
                    ...
                    <div class="product_info">
                        <h4 class="pdt_name">Mule for men</h4>
