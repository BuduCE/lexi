...
const selected = ref(product.img)
...
const switchImages = (index) => {
    selected.value = images[index].src;
    console.log(selectedImage)
}
</script>
    ...
    <section class="product-pg-info">
        <div class="product-pg-img">
            ...
            <div class="small-img-grp">
                <div class="small-img" v-for="(image, index) in images" >
                    <img :src="`${image.src}`" alt="" class="small-pg-img" :key="index" @click="switchImage(index)">
                </div>
            </div>
        </div>
