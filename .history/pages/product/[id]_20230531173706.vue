...
<template>
    ...
    <section class="product-pg-info">
        <div class="product-pg-img">
            <img :src="selectedImage.src" alt="" class="big-pg-img" id="mainImg" v-if="selectedImage">

            <div class="small-img-grp">
                <div class="small-img" v-for="(image, index) in images" @click="switchImage">
                    <!-- <img src="@/assets/store2.svg" alt="" class="small-pg-img" @click="smallImga"> -->
                    <img :src="`${image.src}.svg`" alt="" class="small-pg-img" :key="index">
                </div>
