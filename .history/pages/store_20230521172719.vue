<script setup>
const { data: products.storeProducts } = await useFetch('/api/products'
    , {
    ...
    <section>
        ...
        <section class="store_section">
            <div class="items slide_pane" id="slides">
                ...
                <NuxtLink v-for="product in products.storeProducts" :key="product.id" :to="`product/${product.id}`" id="productOne" class="good">
