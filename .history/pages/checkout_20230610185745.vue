...
const sendMail = async () => {
    ...
    try {
        ...
        emailjs.send(runtimeConfig.public.SERVICE_ID, runtimeConfig.public.TEMPLATE_ID, data, runtimeConfig.public.PUBLIC_KEY);
        btnText.value = 'Sent!';
        setTimeout(() => {
            btnText.value = 'Send';
            email.value = '';
        ...
        console.log("public key", runtimeConfig.public.p)
    } catch (error) {
