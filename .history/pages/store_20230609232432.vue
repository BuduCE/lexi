...
// const cartCount = localStorage.shoppingcart
// filter all entity which type is object
// let allObject = cartCount.filter((val) => {
...
// console.log(LettotalObjects)

const hi = localStorage.shoppingcart.length

// Filter
const filterObjects = (filter) => {
    const filterList = ref([])
    product.filter(a => a.class = filter.class)
};
</script>
...
<template>
    ...
    <NuxtLink to="/cart" class="cart_btn">
